      ...
      <div className="sectionTwo">
        <div className="div1">
          ...
          <p className="colortextDiv1">
            אימון כושר אישי אחד על אחד עם מאמן פרטי. זו אולי הנוסחה
          </p>
          <p className="colortextDiv1">
            המנצחת ליצירת שיגרת אימונים ואורך חיים בריא
          </p>
          <div>
            <p className="colortextDiv1">
            ...
            <p className="colortextDiv1">
              אנו מתבצעים אימון כושר אישי בבית הלקוח ובפארק הירקון בת"א .
            </p>
          </div>
          <ul>
        ...
        <div data-aos="flip-up" className="div3">
          <h2>מאמן כושר</h2>
          <div>
            <img
              className="imgPerson"
              src="https://fitness-tv.co.il/wp-content/uploads/2021/01/about5.jpg"
              alt="ran"
            />
          </div>
          <p className="nameDiv3">
            {" "}
            <strong>רן דורסמן</strong>
          </p>
          <p>מאמן כושר אישי</p>
        </div>
        <div data-aos="flip-down" className="div3">
          <h2>מאמן כושר</h2>
          <div>
            <img
              className="imgPerson"
